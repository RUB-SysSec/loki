...
print(f"average number of assembly instructions/handler (after DCE): {total_num_asm_instructions_after/num_handlers}")
print(f"average number of IL instructions/handler: {total_num_ir_instructions_before/num_handlers}")
print(f"average number of IL instructions/handler (after DCE): {total_num_ir_instructions_after/num_handlers}")
